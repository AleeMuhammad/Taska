  ...
  return (
    <div className="fixed inset-0 flex p-6 justify-center items-center bg-[#a3a3a3] bg-opacity-50">
      <div className="bg-white p-4 sm:p-10 rounded-2xl shadow-lg w-full sm:w-1/2">
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between sm:text-start text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-[#656F7D] text-sm font-normal">Status</h2>
              {selectedTask.status==="Active"?(<p className="bg-[#75D653]  w-fit px-3 rounded text-white font-medium ">Active</p>):selectedTask.status==="Closed"?(<p className="bg-[#F25353] w-fit px-3 rounded text-white font-medium ">Closed</p>):(<p className="bg-[#FFB72B] w-fit px-3 rounded text-white font-medium ">Pending</p>)} 
          </div>
        </div>
